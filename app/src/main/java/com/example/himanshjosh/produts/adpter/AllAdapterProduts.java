...
public class AllAdapterProduts extends RecyclerView.Adapter<AllAdapterProduts.ViewHolder> {

    private AllProductActivity productActivity;
    private ModelGetResponceAllProduct listData;
    private OnClickListner onClickListner;

    public AllAdapterProduts(AllProductActivity productActivity, ModelGetResponceAllProduct listData, OnClickListner onClickListner) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AllAdapterProduts.ViewHolder viewHolder = new AllAdapterProduts.ViewHolder(contactView);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cateType.setText(listData.getProduct().get(position).getCategory());
