...
public class AdpteBankrGrid extends RecyclerView.Adapter<AdpteBankrGrid.ViewHolder> {

    private  FragmentActivity requireActivity;
    private  List<Datum__5> data;
    private OnViewItem onViewItem;




    public AdpteBankrGrid(FragmentActivity requireActivity, List<Datum__5> data,OnViewItem onViewItem) {
    ...
    @NonNull
    @Override
    public AdpteBankrGrid.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View contactView = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_grid, parent, false);

        // Return a new holder instance
        AdpteBankrGrid.ViewHolder viewHolder = new AdpteBankrGrid.ViewHolder(contactView);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdpteBankrGrid.ViewHolder holder, int position) {
